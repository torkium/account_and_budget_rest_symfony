...
class FinancialCategoryFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $expenses = $this->createCategory($manager, 'Dépenses', FinancialCategoryTypeEnum::Undefined);
        ...
        $logement = $this->createCategory($manager, 'Logement', FinancialCategoryTypeEnum::EssentialFixedExpense, $expenses);
        ...
        $alimentation = $this->createCategory($manager, 'Alimentation', FinancialCategoryTypeEnum::EssentialVariableExpense, $expenses);
        $this->createCategory($manager, 'Courses', FinancialCategoryTypeEnum::EssentialVariableExpense, $alimentation);
        $transport = $this->createCategory($manager, 'Transport', FinancialCategoryTypeEnum::EssentialVariableExpense, $expenses);
        ...
        $sante = $this->createCategory($manager, 'Santé', FinancialCategoryTypeEnum::EssentialVariableExpense, $expenses);
        ...
        $loisirs = $this->createCategory($manager, 'Loisirs', FinancialCategoryTypeEnum::NonEssentialFlexibleExpense, $expenses);
        ...
        $education = $this->createCategory($manager, 'Education', FinancialCategoryTypeEnum::EssentialVariableExpense, $expenses);
        ...
        $habillage = $this->createCategory($manager, 'Habillage et soins personnels', FinancialCategoryTypeEnum::NonEssentialFlexibleExpense, $expenses);
        ...
        $donsCadeaux = $this->createCategory($manager, 'Dons et cadeaux', FinancialCategoryTypeEnum::DonationCharity, $expenses);
