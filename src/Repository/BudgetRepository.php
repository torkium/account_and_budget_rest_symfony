...
class BudgetRepository extends ServiceEntityRepository
{
    ...
    public function findBudgetsByDateRange(array $bankAccounts, \DateTime $startDate, \DateTime $endDate, array | null $financialCategories = null, array | null $financialCategoriesType = null, array | null $financialCategoriesTypeToExclude = null, $amountSign = null): array
    {
        $qb = $this->createQueryBuilder('b')
            ->leftJoin('b.financialCategory', 'fc')
            ->where('b.bankAccount IN (:bankAccountIds)')
            ...
            $qb
            ->setParameter('bankAccountIds', array_map(function ($account) { return $account->getId(); }, $bankAccounts))
